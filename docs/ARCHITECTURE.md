# Optimizer architecture and operational reference

This is the detailed reference for `bliss-playlist-optimizer`. Start with the
[repository README](../README.md) for the short orientation, component links,
and common commands.
